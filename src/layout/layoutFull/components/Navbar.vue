<template>
  <header class="h-60px header_scroll w-full bg-white" :class="{ header_fixed: scrollPosition > 150 }">
    <nav class="flex justify-between items-center h-full pl-40">
      ...
      <ul class="flex h-full">
        ...
        <li class="flex items-center h-full dropdown_menu">
          ...
          >
            <span class="font-sans text-xs text-menu_profile uppercase font-bold">{{ displayUsername }}</span>
