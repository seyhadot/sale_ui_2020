                                ...
                                <div class="card-body">
                                        ...
                                        <el-col :span="24">
                                            <el-form-item label="ឈ្មោះសាខាហាង" prop="name">
                                                <el-input v-model="storeForm.name"
                                                          placeholder="Sale What E-commerce"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row :gutter="20">
                                        <el-col :span="24">
                                            <el-form-item label="ឈ្មោះកាត់" prop="shortcutName">
                                                <el-input v-model="storeForm.shortcutName"
                                                          placeholder="SWEM"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                    ...
                                    <el-row>
                                        <el-col :span="24">
                                            <el-form-item label="អាស័យដ្ឋាន" prop="address">
                                                <el-input type="textarea" v-model="storeForm.address"
                                                          rows="2"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                        <el-col :span="24">
                                            <el-form-item label="ពិពណ៌នា">
                                                <el-input type="textarea" v-model="storeForm.desc" rows="2"></el-input>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
                                    <el-row>
                                    ...
                                    <el-row>
                                        <el-col :span="8">
                                            <el-col :span="8">
                                                <el-form-item>
                                                    <el-checkbox v-model="storeForm.closeOrder">បិទការកម្ម៉ង់ទិញ
                                                    </el-checkbox>
                                                </el-form-item>
                                            </el-col>
                                            <el-col :span="8">
                                                <el-form-item>
                                                    <el-checkbox v-model="storeForm.isAddToBuyWhat">Add To Buywhat
                                                    </el-checkbox>
                                                </el-form-item>
                                            </el-col>
                                        </el-col>
                                        ...
                                        <el-col :span="24">
                                            <el-form-item label="Tags">
                                                ...
                                                <el-input class="input-new-tag" v-if="inputTagVisible"
                                                          ...
                                                          size="mini" @keyup.enter.native="handleInputTag"
                                                          @blur="handleInputTag">
                                                </el-input>
                                                <el-button icon="el-icon-plus" v-else class="button-new-tag"
                                                           size="small" @click="showTagInput">
                                                </el-button>
                                            </el-form-item>
                                        </el-col>
                                    </el-row>
  ...
  export default {
    ...
    methods: {
      ...
      fetchUserByStore() {
        ...
        const url = `${provider.baseURL}/user/super/list?req_id=${
          user._id
        }`;
        axios
