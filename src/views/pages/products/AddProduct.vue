      ...
      <el-row :gutter="40">
        <el-col :span="24">
          <el-select filterable clearable v-model="priceOptionId" placeholder="Select Price Options">
            <el-option v-for="item in productOptionsArr" :key="item.value" :label="item.label" :value="item.value"></el-option>
          </el-select>
        </el-col>
        <el-col :span="24">
          <el-row :gutter="20">
            ...
            <el-row :gutter="40">
              ...
              <el-col :span="8">
                <el-form-item :label="$t('product.form.cost')" v-show="isAdmin">
                  <el-input v-model="addProduct.cost" :placeholder="pricePlaceHolder" controls-position="right" :min="1"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
