                ...
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="Description" prop="desc">
                            <el-input v-model="stockForm.desc" type="textarea" rows="3"
                                      placeholder="Write something..."></el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
            </el-form>
        ...
        methods: {
            handleRemove(index, row) {
                ...
                this.$alert(`Remove Stock ${row.productDoc && row.productDoc.name || ''}`, 'Confirm', {
                    ...
                    callback: action => {
                        if (action === 'confirm') {
                            axios.post(url, {userId: user._id}, {headers: {token}})
                                .then(res => {
