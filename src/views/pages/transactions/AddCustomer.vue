            ...
            <div class="card-box first-margin">
              ...
              <div class="card-body mt-5">
                ...
                <el-row :gutter="20">
                  <el-col :span="12">
                    <el-form-item :label="$t('customer.tableData.store')" prop="name">
                      <el-select v-model="customerModel.storeId" :placeholder="$t('customer.selectStore')">
                ...
                <el-row>
                  ...
                  <el-form-item>
                    <el-switch v-model="customerModel.isActive" :active-text="$t('customer.tableData.isActive')" :inactive-text="$t('customer.tableData.isDeactive')"></el-switch>
                  </el-form-item>
                </el-row>
              </div>
            </div>
    ...
    handleSave() {
      this.$refs['customerForm'].validate((valid) => {
        if (valid) {
          ...
          const url = this.customerModel._id
            ? `${provider.baseURL}${provider.prefix}/customers/${this.customerModel._id}/edit`
            : `${provider.baseURL}${provider.prefix}/customers/add`
