  ...
  <div class="content-card xs:w-12/12 sm:w-12/12 lg:w-8/12 px-10 m-auto">
    <el-form :model="storeForm" :rules="rules" ref="store">
      <div class="form-title text-white">
        <h3 class="xs:text-2xl sm:text-4xl xs:text-center lg:text-left lg:text-4xl xl:pl-10 font-bold text-white font-Raleway">{{ $route.meta.title }}</h3>
      </div>
      <el-row class="mt-3" :gutter="40">
        ...
        <el-col class="bg-white p-5" :xs="24" :sm="24" :lg="18">
          ...
          <!-- ---selecttag -->
          <label for>Tag</label>
          <el-select @change="onTagChange" v-model="storeForm.tags" multiple filterable allow-create default-first-option placeholder="Choose tags for your store">
