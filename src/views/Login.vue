                    ...
                    <el-form :model="loginForm" :rules="rules" ref="loginForm">
                                ...
                                <div class="actions w-full mb-3 relative">
                                    <div class="login_form mb-3">
                                        <div class="absolute left-0"
                                             style="z-index: 1;margin-left: 10px;margin-top: 8px;}">
                                            <i class="uil-user text-menu_gray"></i>
                                        </div>
                                        <el-input class="input_email" placeholder="ឈ្មោះគណនី"
                                                  v-model="loginForm.username" prop="username"></el-input>
                                    </div>
                                    ...
                                    <div class="login_form mb-3">
                                        ...
                                        <el-input class="input_email" placeholder="លេខសំងាត់"
                        ...
                        <div>
                            <el-form-item class="action flex w-full justify-center">
                                <el-button type="primary" class="btn-block w-48" @click="handleLogin"
                                           :loading="isLoading">{{ showLoadingText }}
                                </el-button>
                            </el-form-item>
                            <el-form-item class="action flex w-full justify-center">
